...
<body>
    <div class="container bg-white">
        ...
        <div class="row">
            ...
            //
            echo '<div>Vous avez '.mysqli_num_rows($req).' categories administrables</div>';
            //
            if(mysqli_num_rows($req)>0){
               ...
               while($cat = mysqli_fetch_array($req)){
                   ...
                   //no-active, ces valeurs servirons au filtre javascript :)
                    ...
                    <img src="../images/categories/'.$cat['cat_visuel'].'" alt="" onload="checkSize('.$cat['cat_id'].');"
                     id="img'.$cat['cat_id'].'">'.$cat['cat_nom'].'<div class="pull-right">
